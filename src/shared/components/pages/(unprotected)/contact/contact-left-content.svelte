...
<div class="sticky top-32">
	<span class="mb-4 block font-sans text-xs font-bold tracking-widest text-primary uppercase">
		Start Your Project
	</span>

	<h2 class="mb-8 font-serif text-5xl italic leading-tight md:text-6xl text-foreground">
		We only take<br />
