...
<section id="work" class="bg-charcoal py-20 md:py-32">
	<div class="container mx-auto max-w-8xl px-6 md:px-12 lg:px-24">
		<div class="mb-12 w-full md:mb-20">
			<p class="text-sm tracking-widest text-neutral-400 uppercase">{m['RootPage.WorkSection.eyebrow']()}</p>
			<h2 class="mt-2 text-4xl font-medium tracking-tight text-cream md:text-6xl">
