    ...
    <Marquee>
        {#each [...TRUSTED_BY_DATA, ...TRUSTED_BY_DATA] as link, i (link.href + '-' + i)}
            ...
            <a
                ...
                class="flex items-center gap-3 shrink-0 text-2xl font-black tracking-tight uppercase transition-opacity hover:opacity-80"
                style={['Kontent Kolektiv', 'BGApartman', 'Crys Sports', 'FollowUs'].includes(label) ? undefined : `color: ${link.color}`}
            ...
            >
                ...
                {:else}
                    <img
                        ...
                        loading="lazy"
                        onerror={(e) => { const el = e.currentTarget as HTMLImageElement; if (el) el.style.display = 'none'; }}
                    />
                {/if}
                ...
                {:else if label === 'Crys Sports'}
                    <span class="trusted-by-normal-case trusted-by-cryssports inline whitespace-nowrap"><span style="color: #2563eb">Crys</span><span style="color: #dc2626">Sports</span></span>
                {:else if label === 'FollowUs'}
                    <span class="trusted-by-normal-case trusted-by-followus inline whitespace-nowrap"><span class="trusted-by-followus-follow text-neutral-500">Follow</span><span class="trusted-by-followus-us">US</span></span>
