...
<div class="container mx-auto w-full max-w-8xl overflow-hidden px-6 md:px-12 lg:px-24">
    <Separator />
    
    <div class="flex w-full min-w-0 flex-col gap-2 md:gap-3 lg:gap-2">
        <p id="trusted-by-heading" class="w-full text-left text-base font-bold text-neutral-500 md:text-2xl">
